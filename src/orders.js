...
const readlineSync = require('readline-sync'); // Assurez-vous d'installer readline-sync avec npm install readline-sync
...
async function deletePurchaseOrder(id) {
  try {
    ...
    console.error('Erreur lors de la suppression de la commande d\'achat ');
  }
}
